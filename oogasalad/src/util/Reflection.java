...
public class Reflection
{
                                                          ...
                                                          throws ReflectionException
    {
        ...
        catch (ClassNotFoundException e)
        {
            ...
            ErrorLogger.writeToLog("Incorrectly named class " + className, "severe");
            throw new ReflectionException("Incorrectly named class " + className);
        }
        catch (Exception e)
        {
            ErrorLogger.writeToLog("No public default constructor for " + className, "severe");
        ...
        try
        {
            ...
            for (Constructor<?> current : c.getDeclaredConstructors())
            {
                ...
                if (typesMatch(current, formals, args))
                {
                    Object toReturn;
                    try {
                        toReturn = current.newInstance(convertArgs(current, formals, args));
                        return toReturn;
                    }
            ...
            ErrorLogger.writeToLog("No matching public constructor for " + name, "severe");
            throw new ReflectionException("No matching public constructor for " + name);
        }
        catch (ClassNotFoundException e)
        {
            ErrorLogger.writeToLog("Incorrectly named class " + name, "severe");
                                                                ...
                                                                throws ReflectionException
    {
        ...
        catch (Exception e)
        {
            ...
            ErrorLogger.writeToLog("No matching public method " + name +
                                   " for " + target.getClass().getName(), "severe");
                                                                   ...
                                                                   throws ReflectionException
    {
        ...
        catch (Exception e)
        {
            ...
            ErrorLogger.writeToLog("No matching public instance variable for " +
                                   target.getClass().getName(), "severe");
