...
public class PhysicalObjectRect extends PhysicalObject
{
    ...
    private boolean forceIsActive = true;
    ...
    public void changeHeight(double amt) {
//    	myHeight += amt;
    }
    ...
    public void paintShape ()
    {
        ...
        if (forceIsActive) myEngine.setColor(JGColor.green);
        else myEngine.setColor(JGColor.blue);
